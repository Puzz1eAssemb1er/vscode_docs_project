...
3. На верхней панели нажмите кнопку **«Настроить доступ»**.
   ...
   *(Альтернативно: кликните по папке правой кнопкой мыши и выберите пункт «Настроить доступ».)*
   ...
   ![Окно настройки общего доступа к папке на Яндекс Диске](изображения/yandex-disk-share-modal.png)
...
=======
> [!WARNING]  
>>>>>>> 38263a181f34bb99234f0d1f8446fe1e3b384552
...
<details>
  ...
  Все иллюстрации хранятся в папке `изображения`.
</details>
