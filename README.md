...
- Изменения, внесённые любым участником с полными правами, мгновенно отображаются у всех остальных.
- Папка занимает место только на Диске её владельца. У участников она отображается как копия, но не расходует их лимит места.
- Доступ к папке можно настроить индивидуально для каждого пользователя.
...
> [!NOTE]
> Пользователь получит уведомление по почте и сможет принять приглашение. Без аккаунта Яндекса предоставить доступ нельзя.
...
1.  Откройте Яндекс Диск в браузере и войдите в свой аккаунт.
2.  Выберите папку, к которой хотите открыть доступ.
3.  На верхней панели нажмите кнопку **«Настроить доступ»** (или кликните по папке правой кнопкой мыши и выберите этот пункт).
4.  В появившемся окне введите email или имя пользователя Яндекса, которому хотите предоставить доступ.
5.  Выберите уровень прав (подробнее об этом в следующем разделе).
6.  Нажмите кнопку **«Пригласить»**.

> **Важно:** Пользователь получит уведомление по почте и сможет принять приглашение. Без аккаунта Яндекса доступ предоставить нельзя.
...
- **Переименование и перемещение.** Любой участник может переименовать или переместить общую папку в другое место на своём Диске. Это не повлияет на права доступа и не отключит общий доступ.
- **Удаление.** Если участник удалит папку со своего Диска, она исчезнет только у него. Чтобы полностью закрыть доступ всем, владелец должен отключить общий доступ через настройки.
